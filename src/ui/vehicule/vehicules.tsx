...
const Vehicules = () => {
    ...
    const setFiltreParent = (filtre) => {
        console.log(filtre);
    }

    if (isLoading) {
        return <div className=' h-[80vh] flex flex-col items-center '>
            <Filtre setFiltreParent={setFiltreParent} />

            <div className="animate-bounce flex items-center gap-4 h-fit">
    ...
    return (
        <div className=' h-[80vh] flex flex-col items-center'>
            <Filtre setFiltreParent={setFiltreParent} />
            <div className='lg:grid grid-cols-5 flex flex-col gap-4 h-full'>
