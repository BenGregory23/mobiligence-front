...
const PresentationLeft = () => {
    return(
        <div className="flex flex-col w-1/2  relative ">
        <div className="scroll-m-20  pt-2 text-4xl font-semibold tracking-tight first:mt-0 absolute top-4 left-4 text-white flex items-center space-x-2">
            ...
            <span className="text-5xl font-semibold font-montserrat "> Mobiligence</span>
        </div>

        <h1 className="scroll-m-20  pb-2 text-4xl  tracking-tight first:mt-0 absolute bottom-4 left-4 text-white w-3/4 italic font-normal">
            "Organiser les trajets de vos employés n'a jamais été aussi simple"
        </h1>

        <img src="https://images.unsplash.com/photo-1588501302210-35efea6d97ab?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="logo" className="max-h-screen object-cover top-0  " />
    </div>
